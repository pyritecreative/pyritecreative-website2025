<template>
  <footer>
    <h2>Get In Touch</h2>
    <a href="tel:+441453605006" target="_blank">(01453) 605006</a>
    <a
      href="mailto:hello&#64;pyritecreative&#46;com?subject=Website Inquiry"
      target="_blank"
    >
    ...
    <div class="copy">
      &copy;<NuxtTime :datetime="Date.now()" year="numeric" /> Pyrite Creative Ltd
    </div>
  </footer>
</template>
